...
from alignment import alignFloat, genLongestContinuous, genAlign2, genAlign, genAlign3, genLongestContinuous2
    ...
    for i in range(min(len(ruleStr1), len(ruleStr2))):
        if ruleStr1[i] != ruleStr2[i]:
            ...
            if indexA - 1 < 0 or indexAP - 1 < 0:
                continue
            print("\033[0;35;40m", i, sortCSIa1[indexA], sortCSIb1[indexA], sortCSIa1P[indexAP], "\033[0m")
            print(ruleStr1[i], abs(sortCSIa1[indexA] - sortCSIa1P[indexAP]))
            print(ruleStr2[i], abs(sortCSIb1[indexA] - sortCSIa1P[indexAP]))
            print("\033[0;36;40m", sortCSIa1P[indexAP - 1], sortCSIa1P[indexAP], sortCSIa1P[indexAP + 1], "\033[0m")
            print("\033[0;36;40m", sortCSIa1[indexA - 1], sortCSIa1[indexA], sortCSIa1[indexA + 1], "\033[0m")
            print("\033[0;36;40m", sortCSIb1[indexA - 1], sortCSIb1[indexA], sortCSIb1[indexA + 1], "\033[0m")
